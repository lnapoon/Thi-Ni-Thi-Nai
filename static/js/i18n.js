...
const APP_TRANSLATIONS = {
  th: {
    ...
    'composer_caption_placeholder': 'เขียนบรรยายความรู้สึกที่นี่...',
    'composer_place_placeholder': 'ชื่อสถานที่ / คาเฟ่...',
    ...
    'composer_tap_photo': 'แตะเพื่อถ่ายรูป หรือเพิ่มรูปภาพ',
    ...
    'composer_ratio_original': 'ออริจินัล',
    ...
    'composer_pin_map': 'ปักหมุดบนแผนที่',
    'composer_toggle_user_loc': 'เปิดใช้งานการแชร์ตำแหน่งปัจจุบันของคุณ (ผู้โพสต์)',
    'composer_toggle_user_loc_hint': 'เปิดไว้เมื่อต้องการให้ผู้อื่นเห็นจุดที่คุณอยู่จริงขณะเช็คอินเทียบกับจุดที่ปักหมุดบนแผนที่',
    'composer_map_picker_title': 'เลื่อนแผนที่หรือคลิกเพื่อปักหมุดสถานที่',
    'composer_map_picker_sub': 'สามารถเลือกปักหมุดที่ไหนก็ได้ตามต้องการ ระบบจะลากจุดพิกัดละติจูด/ลองจิจูดให้เอง',
    'composer_use_this_location': 'ใช้ตำแหน่งนี้',
    'composer_pinned': 'ปักหมุดแล้ว',
    'detail_place_pin': 'จุดเช็คอิน',
    'detail_toggle_user_loc': 'ตำแหน่งผู้โพสต์',
    'dedication_tag': 'ระบบเช็คอินและปักหมุดสถานที่พัฒนาขึ้นเพื่อ',
    ...
    'edit_profile_category': 'หมวดหมู่ / สถานะ',
    ...
    'edit_profile_first_name_ph': 'ระบุชื่อจริง',
    'edit_profile_last_name_ph': 'ระบุนามสกุล',
    'edit_profile_email_ph': 'ระบุอีเมลของคุณ',
    'edit_profile_display_name_ph': 'ระบุชื่อที่ต้องการให้แสดงบนโปรไฟล์',
    'edit_profile_category_ph': 'ระบุหมวดหมู่หรือสถานะ เช่น นักเดินทาง, สายท่องเที่ยว',
    'edit_profile_bio_ph': 'เขียนแนะนำตัว หรือเล่าเรื่องราวเกี่ยวกับตัวคุณสั้นๆ...',
    ...
    'search_prompt_title': 'ค้นหาเพื่อนนักเดินทาง',
    'search_prompt_desc': 'พิมพ์ชื่อผู้ใช้ (@username) หรือชื่อเพื่อนในช่องค้นหาด้านบนเพื่อเริ่มต้นค้นหา',
  ...
  en: {
    ...
    'composer_caption_placeholder': 'Write a caption here...',
    'composer_place_placeholder': 'Place name / Cafe...',
    'composer_add_photo': 'Add Photos',
    'composer_add_photo_short': 'Add Photo',
    'composer_change_photo': 'Change Photo',
    'composer_gps': 'GPS',
    'composer_post': 'Post',
    'composer_posting': 'Posting...',
    'composer_tap_photo': 'Tap to take photos or select images',
    ...
    'composer_ratio_original': 'Original',
    ...
    'composer_pin_map': 'Pin on Map',
    'composer_toggle_user_loc': 'Share your live poster location',
    'composer_toggle_user_loc_hint': 'Enable so others can see where you actually were when checking in',
    'composer_map_picker_title': 'Pan map or click to pin place location',
    'composer_map_picker_sub': 'Pin anywhere you like, latitude & longitude will auto-populate',
    'composer_use_this_location': 'Use This Location',
    'composer_pinned': 'Pinned',
    'detail_place_pin': 'Check-in Spot',
    'detail_toggle_user_loc': 'Poster Location',
    'dedication_tag': 'Check-in & Mapping System Dedicated to',
    ...
    'edit_profile_category': 'Category / Status',
    ...
    'edit_profile_first_name_ph': 'Enter your first name',
    'edit_profile_last_name_ph': 'Enter your last name',
    'edit_profile_email_ph': 'Enter your email address',
    'edit_profile_display_name_ph': 'Enter your profile display name',
    'edit_profile_category_ph': 'Enter category or status e.g. Traveler, Photography Lover',
    'edit_profile_bio_ph': 'Write a short bio or introduction about yourself...',
    ...
    'search_prompt_title': 'Find Fellow Travelers',
    'search_prompt_desc': 'Type a username (@username) or friend name above to start searching',
...
const RAW_AUTO_PHRASES = [
  ...
  { th: '16:9', en: '16:9' },
  { th: '9:16', en: '9:16' },
  { th: 'เพิ่มรูปภาพ', en: 'Add Photos' },
  { th: 'เพิ่มรูปภาพ (สูงสุด 10 รูป)', en: 'Add Photos' },
  { th: '(สูงสุด 10 รูป)', en: '(Max 10 photos)' },
  { th: 'แตะเพื่อถ่ายรูป หรือเพิ่มรูปภาพ', en: 'Tap to take photos or select images' },
  { th: 'แตะเพื่อถ่ายรูป หรือเพิ่มรูปภาพ (สูงสุด 10 รูป)', en: 'Tap to take photos or select images' },
  ...
  { th: 'ชื่อสถานที่ / คาเฟ่...', en: 'Place name / Cafe...' },
  { th: 'ชื่อสถานที่ / คาเฟ่ / แหล่งท่องเที่ยวที่นี่...', en: 'Place name / Cafe...' },
  { th: 'เขียนบรรยายความรู้สึกที่นี่...', en: 'Write a caption here...' },
  ...
  { th: 'หมวดหมู่ / สถานะ', en: 'Category / Status' },
  { th: 'หมวดหมู่ / สถานะ (เช่น นักเดินทาง, สายคาเฟ่)', en: 'Category / Status (e.g. Traveler, Cafe Lover)' },
  ...
  { th: 'อีเมล', en: 'Email address' },
  { th: 'ระบุชื่อจริง', en: 'Enter your first name' },
  { th: 'ระบุนามสกุล', en: 'Enter your last name' },
  { th: 'ระบุอีเมลของคุณ', en: 'Enter your email address' },
  { th: 'ระบุชื่อที่ต้องการให้แสดงบนโปรไฟล์', en: 'Enter your profile display name' },
  { th: 'ระบุหมวดหมู่หรือสถานะ เช่น นักเดินทาง, สายท่องเที่ยว', en: 'Enter category or status e.g. Traveler, Photography Lover' },
  { th: 'เขียนแนะนำตัว หรือเล่าเรื่องราวเกี่ยวกับตัวคุณสั้นๆ...', en: 'Write a short bio or introduction about yourself...' },
  ...
  { th: 'ที่แล้ว', en: 'ago' },
  { th: 'รายการความคิดเห็น', en: 'comments' },
  { th: 'คน', en: 'people' },
